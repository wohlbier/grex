...
class tut_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tut 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tut 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tut_2")
...
def main(top_block_cls=tut_2, options=None):
